class VehicleNotesButton extends VehicleNotesController {
    template = `
        <button
            class="btn vehicle-note-btn-wrapper half-width-in-thin"
        ...
        >
            <v-popover>
                ...
                >
                    ...
                    <span v-if="withLabel" class="note-btn-text">Note</span>
                </span>
