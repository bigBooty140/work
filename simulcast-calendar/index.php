...
<link href="/css/bootstrap/plugins/datetimepicker/bootstrap-datetimepicker.css" media="screen" rel="stylesheet" type="text/css" >
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="visible-xxs">
                <a class="btn btn-primary btn-sm btn-block" href="simulcast-calendar.html">
                    <i class="fa fa-eye"></i>&nbsp;&nbsp;
                    Viewed Vehicles                </a>
                            </div>
        </div>
...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="panel-body">            <div class="input-group">
			...
			var keywordSearchUrl = "simulcast-calendar.html";
		</script>
    </div>
</div>
</div>
...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td style="width:400px"><a href="mailto:bonny@auctionfinance.co.za">bonny@auctionfinance.co.za </a>&nbsp;</td>
